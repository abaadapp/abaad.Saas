...
class BranchController extends Controller
{
    ...
    public function destroy($id)
    {
        ...
        if ($left > 0) {
             ...
             * التاجر عن زرٍّ ليس موجودًا ثمّ يظنّ العطب في بصره. ثمّ صارت
             * تدلّه على حركتين يدويّتين — بابٌ أعرج لا وثيقةَ تربط طرفيه.
             *
             * واليوم للنقل سندُه: وثيقةٌ واحدة تصرف من فرعٍ وتضيف في آخر في
             * معاملةٍ واحدة. فتُسمّيه الرسالة باسمه.
             */
            return back()->withErrors(['branch' => __(
                'في «:branch» ما زال :qty قطعة. انقلها إلى فرعٍ آخر من المخزون ← النقل بين الفروع، ثم احذفه.',
