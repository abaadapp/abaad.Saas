...
class BranchController extends Controller
{
    ...
    public function destroy($id)
    {
        ...
        if ($left > 0) {
             ...
             * أصلًا: لا مسار ولا شاشة ولا سند. فيبحث التاجر عن زرٍّ ليس
             * موجودًا، ثمّ يظنّ العطب في بصره أو في النظام.
             *
             * والباب القائم اليوم حركتان يدويّتان: صرفٌ من هذا الفرع وإضافةٌ
             * في الآخر من شاشة المخزون. وهو أعرج — لا وثيقةَ تربط الطرفين —
             * لكنّه ما يستطيع فعله الآن، فيُقال له كما هو.
             */
            return back()->withErrors(['branch' => __(
                'في «:branch» ما زال :qty قطعة. اصرفها منه وأضفها إلى فرعٍ آخر من المخزون ← تعديل يدوي، ثم احذفه.',
