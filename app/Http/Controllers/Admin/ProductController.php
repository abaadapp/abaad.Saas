...
class ProductController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        /*
         * ولا يُوقَظ صنفٌ أُوقف بحفظةٍ لم تُرسله — كالعرض والربط سواء.
         *
         * كان السطر `$request->boolean('active', true)`: طلبٌ لا يحمل الحقل
         * يكتب `true`. والحقلان تحته محروسان بـ`has()` وتعليقُهما يقول
         * القاعدة بلفظها — ثمّ لم تُطبَّق على الثالث.
         *
         * وأثرُه أنّ صنفًا أوقفه صاحبُه (انتهى موسمُه، أو غلط سعرُه) يعود
         * إلى شاشة الصندوق بحفظةٍ لم تطلب ذلك، فيبيعه الكاشير — ولا سطرَ
         * في النظام يقول من أعاده.
         *
         * ولا بابَ اليوم يُرسل جزئيًّا إلى هنا؛ فهذا يُقفل النيّةَ قبل أن
         * يُكتب البابُ الذي يوقظها. والإنشاءُ يبقى على حاله: صنفٌ جديد
         * يُولد حيًّا (انظر `store`).
         */
