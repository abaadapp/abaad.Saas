 ...
 *
 * وأكثرها ليس جديدًا: `site_show_prices` و`site_allow_orders` كانا يُحفظان
...
class SettingsController extends Controller
{
    ...
    public function store(): Response
    {
        ...
        return Inertia::render('Admin/Website/Store', $this->shell($site) + [
            'settings' => [
                'show_prices' => ($marketing['site_show_prices'] ?? '1') === '1',
                'allow_orders' => ($marketing['site_allow_orders'] ?? '0') === '1',
            ],
            'sells' => $site->sells(),
    ...
    public function saveStore(Request $request)
    {
        ...
        MarketingSettings::save($this->bid(), 'website', [
            'site_show_prices' => $data['show_prices'] ? '1' : '0',
            'site_allow_orders' => $data['allow_orders'] ? '1' : '0',
        ]);
