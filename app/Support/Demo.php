...
class Demo
{
     ...
     *
     * `Storefront` تقرأ عملة المتجر من المتجر نفسه لا من الجلسة، وتحتاج
     * الرموز نفسها. ونسخُها هناك يعني رمزين لعملةٍ واحدة يفترقان يوم يُصحَّح
     * أحدهما — فيرى الزبون في المتجر غير ما يرى التاجر في لوحته.
     */
