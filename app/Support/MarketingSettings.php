...
class MarketingSettings
{
    ...
    public const GROUPS = [
        'website' => [
            ...
            'site_domain' => '',
            /*
             * أيّ الطرق الثلاث اختارها التاجر — والفراغ يعني «لم يختر بعد».
             *
             * وهو ما تقرؤه الشاشة لتعرف أتعرض الاختيار أم مسارَ من اختار.
             * انظر App\Support\DomainOptions.
             */
            'site_domain_mode' => '',
            /*
             * اسم النطاق الفرعي المحجوز — الاسم وحده بلا لاحقة.
             *
             * ومفتاحٌ مستقلٌّ عن `site_domain` عمدًا، لا فرعٌ منه: لا شيء على
             * الخادم يقدّم هذا العنوان بعد. فلو كُتب في `site_domain` لسال
             * منه إلى زرّ «الموقع» في الترويسة وإلى شاشة السيو وإلى الفاتورة،
             * ولقاد كلُّ واحدٍ منها إلى عنوانٍ لا يردّ. والفصل يجعل ذلك
             * مستحيلًا بالبناء لا بالانتباه.
             */
            'site_subdomain' => '',
            'site_tagline' => '',
            'site_about' => '',
        ...
        'whatsapp' => [
            ...
            'wa_template_delivered' => 'سُلّم طلبك :number. شكرًا لثقتك بـ:store.',
        ],
        'loyalty' => [
            'loyalty_enabled' => '1',
            'loyalty_earn_rate' => '5',
