...
class MarketingSettings
{
    ...
    public const GROUPS = [
        ...
        'website' => [
            'site_domain' => '',
            /*
             * ومفتاحان يُقرآن — لا كالسبعة المرفوعة فوق.
             *
             * `site_domain_mode`: أيّ الطرق الثلاث اختارها التاجر، والفراغ
             * «لم يختر بعد» فتُعرض عليه البطاقات. تقرؤه شاشة الدومين لتعرف
             * أتسأل أم تعرض مسارَ من أجاب — انظر App\Support\DomainOptions.
             *
             * `site_subdomain`: الاسم المحجوز تحت نطاق أبعاد، بلا لاحقة.
             * ومفتاحٌ مستقلٌّ عن `site_domain` عمدًا لا فرعٌ منه: لا شيء على
             * الخادم يقدّم هذا العنوان بعد، فلو كُتب هناك لسال إلى زرّ
             * «الموقع» في الشريط وإلى الفاتورة، ولقاد كلٌّ منهما إلى عنوانٍ
             * لا يردّ. والفصل يجعل ذلك مستحيلًا بالبناء لا بالانتباه.
             */
            'site_domain_mode' => '',
            'site_subdomain' => '',
        ],
