...
class Permissions
{
    ...
    public const ACTIONS = [
        ...
        /*
         * واعتمادُ السند فعلٌ ثالث: هو الذي يُنشئ الذمّة على المتجر.
         *
         * من يُدخل الأوراق ليس بالضرورة من يقرّ بأنّ المتجر مدينٌ بها —
         * وسندٌ يُرحَّل لحظةَ كتابته يجعل الإدخالَ والإقرارَ فعلًا واحدًا.
         */
        self::INVOICE_APPROVE => 'اعتماد سند المورّد',
        /*
         * والتجاوزُ رابعٌ منفصلٌ عنه: من يعتمد السنداتِ المطابِقة يوميًّا ليس
         * بالضرورة من يقرّر الدفعَ عن بضاعةٍ لم تصل.
         */
    ...
    public const ACTION_ROLES = [
        ...
        // والاعتمادُ للمالك ومدير الفرع — ومن سواهما يُمنحه بالاسم
