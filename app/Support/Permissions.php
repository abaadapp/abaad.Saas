...
class Permissions
{
    ...
    public static function sectionFromRoute(?string $route): string
    {
        ...
        /*
         * إعدادات المتجر تتبع الشاشة التي تُضبط فيها، لا اسم مسارها.
         *
         * انتقلت من «أدوات التسويق» إلى «الإعدادات» وبقيت أسماء مساراتها
         * كما هي — والاسم هو ما يُشتقّ منه المفتاح. فمن يملك «الإعدادات»
         * ولا يملك «التسويق» كان يفتح الشاشة ويملأها ويضغط «حفظ» فيُردّ
         * بـ٤٠٣ لا يفهم سببه: هو في الإعدادات ولم يقترب من التسويق.
         */
        if (str_starts_with($route, 'admin.marketing.website')) {
            return 'settings';
        }
        $parts = explode('.', $route);
