...
final class SaleLines
{
    ...
    public function demand(array $lines): array
    {
        ...
        foreach ($lines as $l) {
            ...
            /*
             * وما لا رفَّ له لا يُفحص ولا يُخصم.
             *
             * كرتُ الهدية صنفٌ يُباع ويُحسب في الفاتورة والتقرير، ولا
             * كرتونةَ له في المخزن تُجرَد. ولولا هذا لَأوقف رفٌّ رصيدُه
             * صفرٌ كلَّ طلبٍ يطلبه — انظر `Store\GiftCard`.
             */
            if ($l['no_stock'] ?? false) {
                continue;
            }
