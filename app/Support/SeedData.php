...
class SeedData
{
    ...
    {
        /*
         * القدرات كلُّها — تفتحها الباقاتُ كلُّها.
         *
         * قرارُ صاحب المنصّة: الفرقُ بين الباقات في الأسقف العدديّة — الفروع
         * والموظفون والمنتجات — لا في ما يُغلق من أبواب.
         *
         * وتُقرأ من `PlanFeatures` لا تُكتب بأسمائها هنا: قدرةٌ تُضاف غدًا
         * تبقى مغلقةً في الباقات الثلاث ولا يقول أحدٌ لماذا.
         *
         * ولا تُترك `null` — وهي تعني «مفتوح» عند الحارس — لأنّ شاشة الباقات
         * تقرأ هذه القائمة فتعرضها مربّعاتٍ مؤشَّرة: `null` تُريه أربعةً
         * فارغةً وكلُّها مفتوحة. وشاشةٌ تقول غير ما يفعله النظام أسوأ من
         * شاشةٍ لا تقول.
         */
        ...
        return [
            [
                ...
                'features' => ['فرع واحد', '3 موظفين', '100 منتج', 'كل القدرات', 'دعم بالبريد الإلكتروني'],
                /*
                 ...
                 * انظر `PlanFeatures`.
                 *
                 * وقرارُ صاحب المنصّة أن تُفتح القدراتُ كلُّها في الباقات
                 * كلِّها: الفرقُ بينها في الأسقف العدديّة — الفروع والموظفون
                 * والمنتجات — لا في ما يُغلق من أبواب. والآلة باقيةٌ كما هي،
                 * فإغلاقُ قدرةٍ يومًا تأشيرةٌ واحدة في شاشة الباقات.
                 */
                'capabilities' => $all,
            ],
            [
                'name' => 'الباقة الاحترافية', 'monthly' => 24.900, 'yearly' => 249.000, 'color' => 'secondary', 'popular' => true,
                'features' => ['3 فروع', '15 موظف', 'منتجات غير محدودة', 'كل القدرات', 'دعم فني على مدار الساعة'],
                'capabilities' => $all,
            ],
            [
                'name' => 'باقة المؤسسات', 'monthly' => 59.900, 'yearly' => 599.000, 'color' => 'primary', 'popular' => false,
                'features' => ['فروع غير محدودة', 'موظفون غير محدودين', 'منتجات غير محدودة', 'كل القدرات', 'مدير حساب مخصص'],
                'capabilities' => $all,
            ],
        ];
    }
