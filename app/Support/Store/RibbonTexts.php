...
final class RibbonTexts
{
    private const AR = [
        ...
        'catsTitle' => 'تسوّق حسب الفئة', 'viewAll' => 'عرض الكل', 'bestTitle' => 'الأكثر مبيعاً', 'newTitle' => 'وصل حديثاً',
    ...
    private const EN = [
        ...
        'catsTitle' => 'Shop by category', 'viewAll' => 'View all', 'bestTitle' => 'Best sellers', 'newTitle' => 'New arrivals',
