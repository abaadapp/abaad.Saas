...
class TenantTables
{
    ...
    public const NOT_MINE = [
        ...
        /*
         * ═══ سجلُّ الأرشيف الشهريّ — صفوفٌ تصف ملفّاتٍ لا تُنسخ معها ═══
         *
         * الصفُّ يقول «أرشيفُ أغسطس جاهز، حجمُه ٢٤ ميجابايت، وبصمتُه كذا»،
         * والملفُّ نفسُه ZIP على القرص خارج القاعدة. والنسخةُ تحمل القاعدة.
         *
         * فاستعادتُه تُنشئ في الشاشة ثلاثةَ صفوفٍ خضراء مكتوبٌ عليها «جاهز»
         * وأزرارُ تنزيلٍ تردّ ٤٠٤ — وبابٌ معروضٌ لا يُفتح أسوأ من بابٍ لا
         * يُعرض. وهي بذاتها لا تُفقد: ما ضاع منها يُعاد توليدُه من بيانات
         * الشهر نفسِها بضغطة.
         *
         * وهذا هو الفرقُ بين النسختين في سطر: تلك تُستعاد، وهذا يُقرأ.
         */
        'business_archives' => 'سجلُّ الأرشيف الشهريّ — يصف ملفّاتِ ZIP على القرص لا تحملها النسخة، واستعادتُه تصنع أزرارَ تنزيلٍ تردّ ٤٠٤',
        ...
        'crm_reads' => 'ما قرأه موظّفو مبيعات أبعاد من محادثاتهم — علامةُ قارئٍ عندنا لا بيانَ متجر',
        /*
        ...
        'crm_attachments' => 'ملفّاتُ تلك الرسائل — صورةٌ أرسلها عميلٌ محتمَل إلى أبعاد، لا مرفقُ متجر',
        'crm_ai_feedback' => 'حكمُ فريق المبيعات على اقتراحات المساعد — عملُ المنصّة الداخليّ',
    ];
