...
class Preview
{
     ...
     * لم يصل لا يُبحث فيه. ومئتان حدٌّ لا سقفُ طموح: مستندٌ بألفِ منتجٍ يصير
     * ثقيلًا على هاتفٍ في شبكةٍ ضعيفة، ويومَ يكبر كتالوجُ تاجرٍ عن هذا يصير
     * الترشيح في الخادم — ولا يتغيّر شكلُ الصفحة.
     */
