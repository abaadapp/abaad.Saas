...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'variant_id' => 'الخيار',
        'slug' => 'مسار الصفحة',
        'tracks_stock' => 'تتبّع المخزون',
        'show_in_pos' => 'الظهور في نقطة البيع',
        'show_on_website' => 'الظهور في الموقع',
        'show_prices' => 'إظهار الأسعار',
        'prices_include_tax' => 'الأسعار شاملة الضريبة',
        'sort_order' => 'ترتيب العرض',
        'allow_addons' => 'السماح بالإضافات',
        'allow_components' => 'السماح بالمكوّنات',
        'components_restockable_default' => 'إعادة المكوّنات إلى المخزون افتراضيًّا',
        'base_label' => 'اسم الأساس',
        'base_label_en' => 'اسم الأساس بالإنجليزية',
        'inventory_product_id' => 'صنف المخزون',
        'inventory_quantity' => 'كمية المخزون',
        'wastage_percent' => 'نسبة الهدر',
        'quantity_delta' => 'مقدار التغيير',
        'counts' => 'الكميات المعدودة',
        'counts.*' => 'الكمية المعدودة',
        'adjusted_at' => 'تاريخ التسوية',
        'branch_mode' => 'نطاق الفروع',
        'product_ids' => 'الأصناف',
        'product_ids.*' => 'الصنف',
        'images.*' => 'الصورة',
        ...
        // تركيبة المنتج
        'composition' => 'تركيبة المنتج',
        'composition.addon_ids' => 'الإضافات',
        'composition.new_addons' => 'الإضافات الجديدة',
        'composition.new_addons.*.name' => 'اسم الإضافة',
        'composition.new_addons.*.name_en' => 'اسم الإضافة بالإنجليزية',
        ...
        'composition.recipe.*.quantity' => 'كمية المكوّن',
        'composition.recipe.*.variant_index' => 'خيار المكوّن',
        'composition.recipe.*.wastage_percent' => 'نسبة هدر المكوّن',
        'composition.variants' => 'الخيارات',
        'composition.variants.*.name' => 'اسم الخيار',
        'composition.variants.*.name_en' => 'اسم الخيار بالإنجليزية',
        'composition.variants.*.price' => 'سعر الخيار',
        'composition.variants.*.sku' => 'رمز الخيار',
        ...
        'alert_enabled' => 'تنبيه على العميل',
        ...
        'expected_delivery_at' => 'تاريخ الوصول المتوقّع',
        ...
        'cheque_due_at' => 'تاريخ استحقاق الشيك',
        'internal_notes' => 'ملاحظات داخلية',
        'lines.*' => 'سطر المستند',
        'has_header' => 'الورقة تحمل ترويسة',
        'items.*.description' => 'وصف البند',
        'items.*.discount' => 'خصم البند',
        'items.*.unit_price' => 'سعر الوحدة',
        'items.*.tax_rate' => 'نسبة ضريبة البند',

        // المشتريات والموردون
        'purchase_order_id' => 'أمر الشراء',
        'supplier_ref' => 'مرجع المورّد',
        'supplier_reference' => 'مرجع المورّد',
        'supplier_discount' => 'خصم المورّد',
        'shipping_cost' => 'تكلفة الشحن',
        'payment_reference' => 'مرجع السداد',
        'payment_terms_days' => 'مدّة السداد بالأيام',
        'override_reason' => 'سبب التجاوز',
        'approve_now' => 'الاعتماد الآن',
        'from' => 'مصدر المال',
        'items.*.purchase_unit' => 'وحدة الشراء',
        'items.*.units_per_purchase_unit' => 'محتوى وحدة الشراء',

        // الرواتب والموظفون والبوتيكات
        ...
        // نماذج الطلبات الخاصّة
        'fields' => 'حقول النموذج',
        'fields.*.id' => 'معرّف الحقل',
        'fields.*.label' => 'اسم الحقل',
        'fields.*.label_en' => 'اسم الحقل بالإنجليزية',
        'fields.*.type' => 'نوع الحقل',
        'fields.*.required' => 'الحقل مطلوب',
        'fields.*.active' => 'تفعيل الحقل',
        'fields.*.internal' => 'حقلٌ داخليّ',
        'fields.*.options' => 'خيارات الحقل',
        'fields.*.options.*.id' => 'معرّف الخيار',
        'fields.*.options.*.label' => 'اسم الخيار',
        'fields.*.options.*.label_en' => 'اسم الخيار بالإنجليزية',
        'fields.*.options.*.active' => 'تفعيل الخيار',

        // الموقع الإلكتروني وقوالبه
        'goal' => 'هدف الموقع',
        'adopt' => 'تبنّي القالب',
        'cover' => 'صورة الغلاف',
        'tagline' => 'الجملة التعريفية',
        'hostname' => 'اسم النطاق',
        'site_on' => 'تشغيل الموقع',
        'site_domain' => 'نطاق الموقع',
        'site_path' => 'مسار الموقع',
        ...
        'theme.text' => 'لون النص',
        'theme.button' => 'لون الزرّ',
        'theme.font' => 'الخطّ',
        'theme.radius' => 'استدارة الحواف',
        'seo' => 'إعدادات الظهور',
        'seo.title' => 'عنوان الظهور',
        'seo.description' => 'وصف الظهور',
        'seo.image' => 'صورة الظهور',

        // المتجر الإلكتروني
        'store_on' => 'تشغيل المتجر',
        'store_theme' => 'قالب المتجر',
        'store_headline' => 'عنوان المتجر',
        'store_tagline' => 'جملة المتجر التعريفية',
        'store_about' => 'نبذة المتجر',
        'store_about_image' => 'صورة النبذة',
        ...
        'store_block_title' => 'عنوان الشريط',
        'store_block_text' => 'نصّ الشريط',
        'store_block_image' => 'صورة الشريط',
        'store_block_cta' => 'زرّ الشريط',
        'store_block_href' => 'رابط الشريط',
        'store_show_prices' => 'إظهار الأسعار',
        'store_allow_orders' => 'قبول الطلبات',
        'store_fulfil' => 'طريقة الاستلام',
        'store_whatsapp' => 'رقم واتساب المتجر',
        ...
        'store_gift_card_price' => 'سعر بطاقة الإهداء',
        'store_max_days' => 'أقصى مدّة للحجز',
        'store_seo_title' => 'عنوان المتجر في البحث',
        'store_seo_desc' => 'وصف المتجر في البحث',
        'store_seo_index' => 'ظهور المتجر في البحث',
        'loyalty_enabled' => 'تفعيل نقاط الولاء',
        'loyalty_earn_rate' => 'معدّل كسب النقاط',
        'loyalty_redeem_max_pct' => 'أقصى نسبة استبدال',
        'loyalty_redeem_min' => 'أدنى رصيد للاستبدال',

        // التكاملات وإعدادات المنصّة
        'account' => 'الحساب',
        'place_id' => 'معرّف المكان',
        'google_api_key' => 'مفتاح خرائط جوجل',
        'ga_measurement_id' => 'معرّف قياس جوجل',
        'gbp_alerts_enabled' => 'تنبيهات نشاطي على جوجل',
        'gbp_low_rating' => 'حدّ التقييم المنخفض',
        'google_review_on_receipt' => 'طلب التقييم على الإيصال',
        'google_show_on_site' => 'عرض التقييمات في الموقع',
        'allow_orders' => 'قبول الطلبات',
