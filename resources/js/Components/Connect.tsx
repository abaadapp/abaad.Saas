 ...
 *
 * والهيئةُ من `Gate` المشترك: ثلاثُ شاشاتٍ كانت ترسم البابَ نفسه بيدها
 * فاختلفت مقاساتُها. وما يخصّ هذه وحدها: الزرُّ يكتب علامةَ البدء.
 */
...
export function ConnectSteps({ readiness, title, done, waiting, className }: {
    readiness: Readiness;
    /* مترجَمةً من المنادي: `t()` داخل مكوّنٍ يبتلع النصّ من حارس الترجمة —
       يفحص `t('…')` في المصدر وخصائصَ معدودة، لا خاصّيةً نخترعها */
    title: string;
