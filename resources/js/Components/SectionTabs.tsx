...
/*
 * ═══ ومن لبس واجهةً خاصّة — شريطُه أربعةٌ لا ستّة ═══
 *
 * المساراتُ نفسُها والشكلُ نفسُه، وما سقط سقط لأنّه **لا وجود له عنده** لا
 * لأنّه مُنع:
 *
 *   «التصميم» — قالبٌ يُبدَّل وألوانٌ تُختار. وواجهةُ RIBBON تصميمُ صاحبها
 *   في قالبٍ واحد، لا قوالبَ تُعرض عليه.
 *
 *   «الصفحات» — صفحاتٌ تُضاف وتُحذف. وواجهتُه صفحةٌ واحدة، وتبويبُها
 *   «صفحة المتجر» يفتح محرّرَها.
 *
 * وتبويبٌ يُعرض ثمّ يردّ من ضغطه أسوأُ من تبويبٍ لا يُعرض: الأوّل يُعلّمه
 * أنّ الشاشةَ تكذب، والثاني لا يَعِد بشيء.
 */
export const THEME_TABS: SectionTab[] = [
    { label: 'عام', routeName: 'admin.website.site', section: 'website' },
    { label: 'صفحة المتجر', routeName: 'admin.website.editor', section: 'website' },
    { label: 'المتجر والطلبات', routeName: 'admin.website.shop', section: 'website' },
    { label: 'العنوان والنشر', routeName: 'admin.website.domain', section: 'website' },
];
