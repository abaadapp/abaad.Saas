...
/*
 * ═══ ومن لبس واجهةً خاصّة — الشريطُ نفسُه ═══
 *
 * كان له شريطٌ من أربعة: أُسقط منه «التصميم» و«الصفحات» لأنّ واجهةَ RIBBON
 * قالبٌ واحدٌ وصفحةٌ واحدة، وسُمّي تبويبان بغير اسميهما هنا.
 *
 * ثمّ صار لمتجره ما لسائر متاجر أبعاد: أربعُ صفحاتٍ وقائمةٌ تصل بينها
 * (انظر `Store\StoreNav`)، وعنوانٌ ووصفٌ يقرؤهما غوغل (`Store\StoreSeo`).
 * فلم يبقَ ما يُسقط — والشريطُ واحدٌ لا شريطان.
 *
 * ولا يُكتب `THEME_TABS` بالقيم نفسِها إلى جانب هذا: قائمتان تقولان الشيء
 * نفسَه تفترقان عند أوّل إضافة، فيرى صاحبُ الواجهة تبويبًا لا يراه جاره.
 */
