...
/*
 * ═══ ومن لبس واجهةً خاصّة — شريطٌ من اثنين ═══
 *
 * كان شريطَ جاره بعينه: ستّةُ تبويبات. وكان ذلك صحيحًا يومَ كان لكلٍّ منها
 * شاشةٌ تُملأ. ثمّ قِيست الشاشاتُ فوُجد التوزيعُ غيرَ عادل: ثلاثٌ فيها
 * ثلاثةُ مقابض، وواحدةٌ فيها اثنان وثلاثون — وفوقها شاشةُ «عام» التي هي
 * **قائمةٌ ثانية** تكرّر الشريطَ نفسَه في سبع بطاقات.
 *
 * فصار ضبطُه صفحةً واحدة بعمودٍ يقفز (`ThemeSettings`)، ولم يبقَ ممّا
 * يُنتقل إليه إلّا وجهتان: صفحتُه التي تُرسَم، وضبطُه الذي يُملأ.
 *
 * وهنا يفترق عن جاره عن حقّ لا عن سهو: البانِي مواقعُ كثيرةٌ وصفحاتٌ تُضاف
 * وقوالبُ تُبدَّل، وهذه واجهةٌ واحدةٌ بصفحاتٍ أربعٍ مكتوبة.
 */
export const THEME_TABS: SectionTab[] = [
    { label: 'التصميم', routeName: 'admin.website.editor', section: 'website' },
    { label: 'الإعدادات', routeName: 'admin.website.site', section: 'website' },
];
