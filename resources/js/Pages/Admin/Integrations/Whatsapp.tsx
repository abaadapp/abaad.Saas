...
import { Gauge, MessageCircle, Save, Smartphone, SlidersHorizontal } from 'lucide-react';
        ...
        return (
            <AdminLayout title="واتساب بزنس">
                ...
                <ConnectGate
                    icon={MessageCircle}
                    title="واتساب بزنس"
                    description="يصل العميل خبرُ طلبه على واتساب لحظةَ تغيّره — بلا أن يتّصل أحد."
                    tool="whatsapp"
                    tint="#25d366"
