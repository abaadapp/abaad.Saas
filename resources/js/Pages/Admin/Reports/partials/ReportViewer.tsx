 ...
 *
 * أربعةٌ من تقارير الفهرس ليست أقسامًا في اللوحة بل قراءاتٌ عليها: وسائل
 * الدفع، وأداء الموظفين، والمبيعات حسب القسم، والعملاء الأكثر إنفاقًا. لا
 * يُصنع لكلٍّ منها صفحةٌ ومسارٌ وتبويب — الخادم يعرفها أصلًا أعمدةً وصفوفًا
 * (ReportDataController)، فتُعرض هنا كما هي وتُطبع.
 *
 * ويُطلب التقرير عند الفتح لا عند تحميل الصفحة: أربعة طلبات لأربع بطاقاتٍ
 * قد لا تُفتح واحدةٌ منها تُبطئ الفهرس بلا مقابل.
 */
