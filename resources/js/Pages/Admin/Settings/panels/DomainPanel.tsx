...
/**
 * حقول مجموعة `website` الثمانية — نموذجٌ واحد تتشاركه بطاقتا الدومين والموقع.
 *
 * كلتاهما تحفظ الثمانية كاملةً، فلا يُمحى ما في إحداهما بحفظ الأخرى. انظر
 * تعليق `siteForm` في Settings/Index.
 */
export interface SiteFormData {
    ...
    site_allow_orders: boolean;
}

interface Props {
    domain: DomainData;
    /** نموذج الموقع المشترك — النطاق والنشر حقلان فيه */
    siteForm: InertiaFormProps<SiteFormData>;
    /** عدد المنتجات التي ستظهر في الموقع */
    published: number;
    /** حفظ إعدادات الموقع الثمانية — مشترك مع بطاقة «الموقع» */
 ...
 */
export default function DomainPanel({ domain, siteForm, published, onSaveSite }: Props) {
        ...
        <div className="mb-5 flex flex-wrap items-start justify-between gap-3">
            <div>
                ...
                <p className="mt-1 text-[13px] text-[#6b7280]">
                    ...
                    */}
                    {t('عنوان متجرك على الإنترنت — وهو ما يفتحه زرّ «الموقع» في الأعلى.')}
                </p>
            </div>
            {mode !== '' && (
