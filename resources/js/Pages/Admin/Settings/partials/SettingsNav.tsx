...
export const SETTINGS_NAV = [
    {
        ...
        items: [
            ...
            /*
             * صار للموقع قسمُه ومحرّكه، وبقي هنا ما هو أوسع منه: الشعار.
             *
             * هو هويّة النشاط لا زينةُ الموقع — يظهر في الفواتير وفي رأس
             * الموقع معًا، فمكانه في الإعدادات لا في محرّر الصفحات.
             */
            { key: 'website', label: 'الشعار وتعريف المتجر', desc: 'شعار متجرك — والموقع نفسه في قسمه', icon: AppWindow },
        ],
    },
    {
        group: 'المالية',
