            ...
            */}
            <div className="flex h-full flex-col gap-4 overflow-hidden p-4 md:flex-row">
                {/*
                  * ===================== المنتجات =====================
                  *
                  * و`min-w-0` ليست زينة: بدونها تختفي السلّة.
                  *
                  * ═══ العطب ═══
                  *
                  * أدنى عرضٍ لعنصرٍ مرنٍ هو `auto` — أي عرضُ محتواه. وصفُّ
                  * البحث والباركود لا ينضغط تحت مقاسه، فيأخذ القسمُ ٩٧٢ بكسل
                  * مهما ضاقت الشاشة، وتُدفع `aside` خارج الإطار — والغلافُ
                  * `overflow-hidden` فتُقصّ ولا تُمرَّر.
                  *
                  * وعلى شاشة ١٠٢٤ — وهي مقاسُ اللوحيّ الذي يقف عليه الصندوق —
                  * كانت السلّة تبدأ عند ‎−٣١١ وتنتهي عند ٢٠: يرى الكاشير
                  * عشرين بكسلًا منها. لا مجموع، ولا زرّ دفع، ولا بند.
                  *
                  * ولم يظهر على شاشة المطوّر لأنّها ١٩٢٠ — وهناك يتّسع الاثنان.
                  */}
