...
export interface Toast {
    ...
    /**
     * زرّ «امضِ على أيّ حال» — يبنيه الخادم حين يردّ فعلًا يحتاج إقرارًا.
     *
...
export interface SharedProps {
    ...
    context: {
        ...
        /**
         * ما يُؤويه هذا المحلّ ممّا ليس لكلّ متجر — مفاتيحُ مغلقة.
         *
         * وليست قدراتِ باقة: تلك تُشترى، وهذه صفةُ محلٍّ بعينه (محلٌّ يُؤجّر
         * أركانَه لبوتيكات). ويفتحها مديرُ المنصّة لمن طلبها.
         */
        hosted?: string[];
