...
<table class="items">
    ...
    <tbody>
        @forelse ($items as $i => $item)
            {{--
                ولا تناوبَ أرضيّةٍ بين الصفوف.

                كان يُحسب هنا لا بـ`nth-child` — وذلك الدرسُ باقٍ: mpdf لا
                يُعوَّل عليه في المحدّدات البنيويّة، فما يُبنى على بنية
                الجدول يخرج في المتصفّح ولا يخرج في الـPDF.

                وذهبت الزِّبرةُ نفسُها: حيلةُ جدولِ أرقامٍ بعشرين عمودًا،
                وفاتورةٌ بأربعةٍ تُقرأ سطرًا سطرًا على شعرةٍ فاصلة. والمرجعُ
                المعتمد: «عدم تحويله إلى spreadsheet».
            --}}
            <tr>
