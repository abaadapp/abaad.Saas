...
<div class="head">
    <table style="border:none;"><tr>
        ...
        <td style="border:none; text-align:left;">
            <div style="font-size:15px; font-weight:bold;">تقرير المبيعات الشهري</div>
...
<h2>حركة المبيعات (آخر 6 أشهر)</h2>
<table>
...
<h2>توزيع وسائل الدفع</h2>
<table>
    <tr><th>الوسيلة</th><th>عدد العمليات</th><th>الإجمالي</th><th style="width:30%;">النسبة</th></tr>
