 ...
 *
 *   تحت الصورة — الادّعاءُ عنها فيعيش معها. **وقبل زرّ الإضافة** لا بعده:
 *   تنبيهٌ يُقرأ بعد القرار ليس تنبيهًا، وعلى الجوّال هو تحت الطيّة.
 *
...
class ASitesPhotoIsNotAPromiseTest extends TestCase
{
    ...
    /**
     * ═══ وتحت الصورة لا في آخر العمود ═══
     *
     * الموضعُ هو المسألةُ كلُّها. السطرُ الوحيدُ الذي كان قريبًا منه
     * («ملاحظة التوصيل») يُرسم **تحت زرّ الإضافة إلى السلّة** — أي على
     * الجوّال بعد الطيّة وبعد أن قرّر الزبون.
     *
     * فيُقاس بترتيبه في الصفحة لا بوجوده: وجودٌ في آخرها يُرضي اختبارًا
     * يسأل «أهو موجود؟» ولا يُرضي زبونًا لم يره.
     */
    public function test_on_the_product_page_it_comes_before_the_add_button(): void
    {
        $this->note('قد يختلف صنفٌ أو لون حسب المتوفر');
