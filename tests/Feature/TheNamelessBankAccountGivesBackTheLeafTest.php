...
class TheNamelessBankAccountGivesBackTheLeafTest extends TestCase
{
    ...
    public function test_the_real_account_inherits_the_leaf_and_its_balance(): void
    {
        ...
        /*
         * شكلُ الإنتاج: المالُ في الصفّ الذي لا اسمَ له، والبنكُ ساكنٌ لا يدخله ريال.
         *
         * والأرقامُ هنا أرقامُ الدفتر وحده. كان `balance()` يجمع الرصيدَ
         * الافتتاحيّ من خارج الدفتر فيقرأ البنكُ ٢٠٠٠ وهو ساكن؛ وصار
         * الافتتاحيُّ يُقيَّد بقيدٍ من بابه (انظر `Bank::syncOpening`) ويُقرأ
         * الرصيدُ من مكانٍ واحد. وهذه الهجرةُ تنقل **ورقةً** لا افتتاحيًّا،
         * فما تحرسه هو أنّ ما في الورقة يعود إلى صاحبها.
         */
        $this->assertSame(147.0, $nameless->fresh()->balance(), 'الحالة قبل الهجرة ليست حالة الإنتاج');
        $this->assertSame(0.0, $real->fresh()->balance(), 'الحالة قبل الهجرة ليست حالة الإنتاج');
